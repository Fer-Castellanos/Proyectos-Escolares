...
public class Harley extends Application {
     ...
     public void start (Stage stage)
    {
        ...
        RadioButton cb = new RadioButton ("Transladar");
                cb.setTranslateY(400);
                
        RadioButton cb1= new RadioButton("Escalar");
                cb1.setTranslateY(425);
                
        RadioButton cb2= new RadioButton("Rotar");
       ...
       //tronco
        ...
        stage.setTitle("Transformaciones");
        stage.show();
