import java.io.*;
/**
 * Write a description of class OrdenExMzclaDirecta here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class OrdenExMzclaDirecta
{
  ...
  {  File f = new File("ArchivoOrigen");    
    ...
    static void mezclaDirecta(File f) throws IOException
    {
        ...
        File f2 = new File("ArchivoAux2");   /* número de registros se obtiene dividiendo el tamaño     del archivo por el tamaño del registro: 4.   */  
    ...
    static void distribuir(File f, File f1, File f2,       int longSec, int numReg) throws IOException 
    {
        ...
        resto =  numReg %(2*longSec);  //distribuye secuencias de longitud longSec 
        for (i = 1; i <= numSec; i++) 
        {
